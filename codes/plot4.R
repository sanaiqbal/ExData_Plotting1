...
#for panel plots we use mfrow##
png(filename = "Plot4.png")
par(mfrow=c(2,2))
with(reqd2,(plot(time2,as.numeric(reqd2[,3]),type="l",xlab="",ylab="Global Active Power")))
with(reqd2,(plot(time2,as.numeric(reqd2[,5]),type="l",xlab="datetime",ylab="Voltage")))
...
with(reqd2,(plot(time2,as.numeric(reqd2[,4]),type="l",xlab="datetime",ylab="Global_Reactive_Power")))
dev.off()
